        ...
        <ul class="pb-2 space-y-2">
          ...
          <li>
            <a href="/services" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
              <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M10 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm0 14a6 6 0 0 1-6-6c0-1.1.36-2.12.97-2.94l8.97 8.97A5.96 5.96 0 0 1 10 16Zm5.03-2.94L6.06 4.97A6 6 0 0 1 16 10c0 1.1-.36 2.12-.97 2.94ZM4 10a6 6 0 0 1 6-6c1.1 0 2.12.36 2.94.97L4.97 12.94A5.96 5.96 0 0 1 4 10Z" clip-rule="evenodd" />
              </svg>
            ...
            <a href="/payment-methods"
              ...
              <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 
                ...
                <path fill-rule="evenodd"
                  d="M2 5.5A2.5 2.5 0 0 1 4.5 3h15A2.5 2.5 0 0 1 22 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-15A2.5 2.5 0 0 1 2 18.5v-13ZM4.5 4a1.5 1.5 0 0 0-1.5 1.5v1h18v-1A1.5 1.5 0 0 0 19.5 4h-15ZM21 8H3v10.5A1.5 1.5 0 0 0 4.5 20h15A1.5 1.5 0 0 0 21 18.5V8Zm-6 9.5a.5.5 0 0 1 .5-.5H17a.5.5 0 1 1 0 1h-1.5a.5.5 0 0 1-.5-.5ZM7 17a1 1 0 1 1 2 0 1 1 0 0 1-2 0Zm-1-2a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1Z"
                  clip-rule="evenodd" />
              </svg>
          ...
          <li>
            <a href="/invoices" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
              <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M6 2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6.828a2 2 0 0 0-.586-1.414L15.586 2.586A2 2 0 0 0 14.172 2H6Zm6 5a1 1 0 0 1 1-1h3.586L18 7.414V18a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5v4Zm-4 6a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2H8Zm0-3a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2H8Z" clip-rule="evenodd" />
              </svg>
