<div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full" id="edit-service-modal">
    <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                ...
                <button type="button" id="editBtnClose" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white" data-modal-toggle="edit-service-modal">
            ...
            <div class="p-6 space-y-6">
                <form id="updateServiceForm">
                    <input type="hidden" id="updateServiceId" value="">
                    ...
                    <div class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                        <button class="text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-[#008443] hover:bg-[#005a2e] focus:ring-4 focus:ring-[#12bb5dd6] dark:bg-[#008443] dark:hover:bg-[#008443] dark:focus:ring-[#12bb5dd6]" type="submit">Update Service</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    async function updateService(event) {
        ...
        try {
            const response = await axios.post('/update-service', formData);
    ...
    $('#updateServiceForm').on('submit', updateService);
</script>
@endpush