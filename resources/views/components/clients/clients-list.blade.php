        ...
        data.forEach(function(item, index) {
            ...
            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 py-2">
                            ...
                            <td class="p-4 space-x-2 whitespace-nowrap border border-gray-300">
                                <button type="button" data-modal-target="edit-client-modal" data-id-${item['id']} data-modal-toggle="edit-client-modal" class="inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                ...
                                <button type="button" data-modal-target="delete-client-modal" data-id-${item['id']} data-modal-toggle="delete-client-modal" class="inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
                                    <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
