    ...
    <div class="w-full mb-1">
        ...
        <div class="sm:flex">
            <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                <button type="button" data-modal-target="add-client-modal" data-modal-toggle="add-client-modal" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg sm:w-auto bg-[#d47a00] hover:bg-[#aa6405] focus:ring-4 focus:ring-[#d8902fa8] dark:bg-[#d47a00] dark:hover:bg-[#aa6405]">
            ...
            let newRow = `
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 py-2">
                    ...
                    <td class="p-4 space-x-2 whitespace-nowrap border border-gray-300">
                        <button type="button" data-modal-target="edit-client-modal" data-id="${item['id']}" data-modal-toggle="edit-client-modal" class="editBtn inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white rounded-lg bg-[#008443] hover:bg-[#005a2e] focus:ring-4 focus:ring-[#12bb5dd6] dark:bg-[#008443] dark:hover:bg-[#008443] dark:focus:ring-[#12bb5dd6]">
