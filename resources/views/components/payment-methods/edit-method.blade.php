            ...
            <div class="p-6 space-y-6">
                <form id="updateMethodForm">
                    ...
                    <div class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                        <button class="text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-[#008443] hover:bg-[#005a2e] focus:ring-4 focus:ring-[#12bb5dd6] dark:bg-[#008443] dark:hover:bg-[#008443] dark:focus:ring-[#12bb5dd6]" type="submit">Update Method</button>
                    </div>
                </form>
            </div>
        </div>
